...
export default function HeatmapControl({ activeHeat, onSelect, counts }: HeatmapControlProps) {
        ...
        >
          ...
          <div className="flex-1 text-left">
            <div
              ...
              style={{ color: activeHeat === "all" ? "#c2410c" : "#374151" }}
            >
              Semua Kategori
            </div>
          </div>
        ...
        <div className="px-3 pb-3">
          <div className="rounded-lg overflow-hidden" style={{ border: "1px solid #f0f0f0" }}>
            <div className="px-2.5 py-1.5 bg-gray-50">
              <p className="text-xs text-gray-500 font-medium">Skala Densitas</p>
            </div>
            <div className="px-2.5 py-1.5 flex items-center gap-1.5">
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(90deg, rgba(0,0,255,0.4), rgba(0,255,0,0.6), rgba(255,255,0,0.8), rgba(255,128,0,0.9), rgba(255,0,0,1))",
                }}
              />
